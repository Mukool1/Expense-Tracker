...
const TESTIMONIALS = [
  {
    quote:
      "Signing up took a minute, and by dinner I had a full picture of my month. Wild.",
    name: "Rohit K.",
    role: "Analyst, Pune",
  },
  {
    quote:
      "The month-end forecast told me exactly how much I could save — I just followed it.",
    name: "Meera J.",
    role: "Doctor, Chennai",
  },
  {
    quote:
      "Finally a money app that doesn't feel like homework. It just quietly does it all.",
    name: "Aditya V.",
    role: "Founder, Delhi",
  },
];

const SPARKLINE = "0,32 24,36 48,30 72,33 96,26 120,28 144,20 168,22 200,12";
  ...
  return (
    <div className="relative hidden min-h-screen w-[46%] flex-col justify-between overflow-hidden bg-gradient-to-br from-indigo-950 via-violet-950 to-fuchsia-950 p-10 lg:flex xl:w-1/2">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="animate-float absolute -right-24 -top-24 h-96 w-96 rounded-full bg-violet-500/40 blur-3xl" />
        <div className="animate-float-slow absolute left-0 top-1/3 h-80 w-80 rounded-full bg-indigo-500/40 blur-3xl" />
        <div className="animate-float absolute -bottom-24 right-1/3 h-96 w-96 rounded-full bg-fuchsia-600/30 blur-3xl" />
      ...
      {/* floating glass visual — month-end forecast */}
      <div className="relative z-10 flex flex-1 items-center justify-center">
        ...
        >
          <div className="rounded-3xl border border-white/20 bg-white/10 p-6 shadow-2xl shadow-black/30 backdrop-blur-xl">
            ...
            >
              <defs>
                <linearGradient id="register-spark" x1="0" y1="0" x2="0" y2="1">
            ...
            <p className="mt-3 text-xs text-indigo-200/70">
              AI forecast based on your spending rhythm — updated daily.
            </p>
          </div>
        </motion.div>
      </div>
        ...
        >
          ...
          <Card className="p-6 sm:p-8">
            ...
            <p className="mt-1.5 text-sm text-slate-500 dark:text-slate-400">
              One minute now, a full picture of your money forever.
            </p>
